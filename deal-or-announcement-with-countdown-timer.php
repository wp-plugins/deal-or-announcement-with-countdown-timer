...
Plugin URI: http://www.gopipulse.com/work/2010/07/18/deal-or-announcement-with-countdown-timer/
Description:  This plug-in will display the announcement or deal or offer with countdown timer.
Author: Gopi.R
Version: 7.0
Author URI: http://www.gopipulse.com/work/2010/07/18/deal-or-announcement-with-countdown-timer/
...
<div class="wrap">
  ...
  <form name="form1" method="post" action="<?php echo @$mainurl; ?>"  onSubmit="return gCountdownform()">
    <table width="100%">
      ...
      <tr>
		...
		<input name="Help" lang="publish" class="button-primary" onclick="window.open('http://www.gopipulse.com/work/2010/07/18/deal-or-announcement-with-countdown-timer/');" value="Help" type="button" />
		</td>
      </tr>
  ...
  <div class="tool-box">
    ...
    <br />Check official website for more details <a target="_blank" href='http://www.gopipulse.com/work/2010/07/18/deal-or-announcement-with-countdown-timer/'>Click here</a><br />
  </div>
</div>
<?php
