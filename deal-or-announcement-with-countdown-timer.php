...
<div class="wrap">
  <?php
    $title = __('Deal with Countdown Timer');
  ...
  <form name="form1" method="post" action="<?php echo $mainurl; ?>"  onSubmit="return gCountdownform()">
    <table width="100%">
      ...
      <tr>
        <td align="left" valign="middle" style="height:30px;"><input name="publish" type="submit" class="button-primary" lang="publish" value="<?php echo $submittext?>" /></td>
      </tr>
  ...
  <div class="tool-box">
    ...
    <h2>Plugin Help</h2>
    <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/deal-or-announcement-with-countdown-timer/'>Click here</a> to see live demo and more help.<br />
  </div>
</div>
<?php
...
{
  	register_sidebar_widget(__('Deal with countdown'), 'deal_or_announcement_with_countdown_timer_widget');   
	
	if(function_exists('register_sidebar_widget')) 	
	{
		register_sidebar_widget('Deal with countdown', 'deal_or_announcement_with_countdown_timer_widget');
	}
	
	if(function_exists('register_widget_control')) 	
	{
		register_widget_control(array('Deal with countdown', 'widgets'), 'deal_or_announcement_with_countdown_timer_control',400,400);
	} 
}
