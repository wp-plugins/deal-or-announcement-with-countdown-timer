...
function widget_deal_or_announcement_with_countdown_timer_management() 
{
    ...
    <table width="100%">
      ...
      <tr>
        <td colspan="2" align="left" valign="middle"><textarea name="gCount" cols="60" rows="3" id="gCount"><?php echo $gCount_x; ?></textarea></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td width="63%" align="right" valign="middle"><input name="publish" lang="publish" class="button-primary" value="<?php echo $submittext?>" type="submit" /></td>
      </tr>
      <tr>
