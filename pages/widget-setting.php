...
<div class="wrap">
  <div class="form-wrap">
	...
	<h3><?php _e('Settings', 'deal-with-countdown'); ?></h3>
    <?php
	...
	if (isset($_POST['gCount_form_submit']) && $_POST['gCount_form_submit'] == 'yes')
	{
		...
		<div class="updated fade">
			<p><strong><?php _e('Details successfully updated.', 'deal-with-countdown'); ?></strong></p>
		</div>
		<?php
	}
	?>
    ...
    <form name="ssg_form" method="post" action="">
	  ...
	  <label for="tag-title"><?php _e('Enter widget title', 'deal-with-countdown'); ?></label>
      ...
      <p><?php _e('Please enter your widget title.', 'deal-with-countdown'); ?></p>
      
	  <label for="tag-title"><?php _e('Timer caption', 'deal-with-countdown'); ?></label>
      ...
      <p><?php _e('Please enter your timer caption.', 'deal-with-countdown'); ?></p>

	  <label for="tag-title"><?php _e('Timer color', 'deal-with-countdown'); ?></label>
      ...
      <p><?php _e('Please enter your timer color.', 'deal-with-countdown'); ?></p>

	  <label for="tag-title"><?php _e('Text color', 'deal-with-countdown'); ?></label>
      ...
      <p><?php _e('Please enter your text color.', 'deal-with-countdown'); ?></p>

	  <label for="tag-title"><?php _e('Timer alignment', 'deal-with-countdown'); ?></label>
      ...
      <p><?php _e('Please select your timer alignment.', 'deal-with-countdown'); ?></p>

	  <label for="tag-title"><?php _e('Text alignment', 'deal-with-countdown'); ?></label>
      ...
      <p><?php _e('Please select your text alignment.', 'deal-with-countdown'); ?></p>
	   
	  <p style="padding-bottom:5px;padding-top:5px;">
		  <input name="gCountsubmit" id="gCountsubmit" class="button" value="<?php _e('Submit', 'deal-with-countdown'); ?>" type="submit" />
